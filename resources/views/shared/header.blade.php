            ...
            <div class="header-logo shrink-0">
                <a href="{{ route('home') }}" rel="home">
                    <img src="{{ Vite::image('logo.svg') }}"
                         class="w-[120px] xs:w-[148px] md:w-[201px] h-[30px] xs:h-[36px] md:h-[50px]" alt="PixelStore">
                </a>
            </div>
                    ...
                    <div x-data="{dropdownProfile: false}" class="profile relative">
                        ...
                        >
                            ...
                            <div class="mt-4">
                                <ul class="space-y-2">
                                    <li>
                                        <a href="{{ route('cart') }}" class="text-body hover:text-white text-xs font-medium">Мои заказы</a>
                                    </li>
