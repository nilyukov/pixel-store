            ...
            <section>
                ...
                <form action="{{ route('order.handle') }}" method="POST"
                    ...
                    <div class="p-6 2xl:p-8 rounded-[20px] bg-card">
                        ...
                        <div class="space-y-3">
                            <x-forms.text-input name="customer[first_name]"
                                                type="text"
                                                placeholder="Имя"
                            ...
                            <x-forms.text-input name="customer[last_name]"
                                                type="text"
                                                placeholder="Фамилия"
                            ...
                            <x-forms.text-input name="customer[email]"
                                                type="email"
                                                placeholder="E-mail"
                            ...
                            <x-forms.text-input name="customer[phone]" type="text" placeholder="Телефон"
                                ...
                                @foreach($deliveries as $delivery)
                                    <div class="space-y-3">
                                        ...
                                        @if ($delivery->with_address)
                                            <x-forms.text-input name="customer[city]"
                                                                type="text"
                                                                placeholder="Город"
                                            ...
                                            <x-forms.text-input name="customer[address]"
                                                                type="text"
                                                                placeholder="Адрес"
